...
<section class="home-contact">
   <div class="container">
      <div class="row justify-content-center">
         <div class=" col-md-12 col-md-12 col-lg-6 col-xl-6 box-contact">
...
<section class="home-service">
   <div class="container">
      ...
      <div class="row mb-4">
         <div class=" col-md-12 col-md-12 col-lg-4 col-xl-4 ">
            <figure>
               <img src="/asset/images/service-2.png" class="img-fluid fixed-image" alt="" srcset="">
               <figcaption>
                  <h3><a href="#abc">THÔNG TIN QUY HOẠCH ĐÔ THI</a></h3>
               </figcaption>
            </figure>
         </div>
         <div class="col-md-12 col-md-12 col-lg-4 col-xl-8">
            <figure>
                  ...
                  <form>
                     <fieldset>
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control form-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email address">
                           <input type="text" class="form-control form-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email address">
                           <textarea class="form-control form-input" placeholder="Email address" id="exampleTextarea" rows="3" style="height: 70px;"></textarea>
